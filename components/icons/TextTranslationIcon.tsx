...
const TextTranslationIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" className={className}>
        <defs>
            <linearGradient id="bcf06cd3-a4b8-4fd5-87ad-fd0a708c782b_translate" x1="9" x2="9" y2="18" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="#5ea0ef"/>
                <stop offset="1" stopColor="#0078d4"/>
            </linearGradient>
            <linearGradient id="ab8b109c-2878-45da-89b4-5b7b4d0302fd_translate" x1="-998.057" y1="-213.109" x2="-1002.698" y2="-204.987" gradientTransform="translate(-195.271 1006.992) rotate(90)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="#fff"/>
                <stop offset="1" stopColor="#fff" stopOpacity="0.3"/>
            </linearGradient>
            <linearGradient id="aa22a732-ecb4-41ce-bd4f-17b24d84fd2f_translate" x1="-122.365" y1="1106.487" x2="-127.006" y2="1114.61" gradientTransform="translate(-1106.024 -112.477) rotate(-90)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="#fff"/>
                <stop offset="1" stopColor="#fff" stopOpacity="0.3"/>
            </linearGradient>
        </defs>
        <rect width="18" height="18" rx="0.6" fill="url(#bcf06cd3-a4b8-4fd5-87ad-fd0a708c782b_translate)"/>
...
export default TextTranslationIcon;