...
const AiStudioIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg id="uuid-6b8380c3-0ee5-4c44-92a2-f185c82db6ba" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" className={className}>
        <defs>
        ...
        <path d="m12.061.012c.534,0,1.008.401,1.178.984s1.166,4.19,1.166,4.19v7.166h-3.607l.073-12.352h1.19v.012Z" fill="url(#uuid-05876c72-8f26-40da-996e-a488172ec072)" fillRule="evenodd" strokeWidth="0"/>
        <path d="m17.356,5.611c0-.255-.206-.449-.449-.449h-2.126c-1.494,0-2.709,1.215-2.709,2.709v4.494h2.575c1.494,0,2.709-1.215,2.709-2.709v-4.045Z" fill="url(#uuid-c4a2f627-d730-447e-9152-62009c64c361)" strokeWidth="0"/>
        <path d="m12.061.012c-.413,0-.741.328-.741.741l-.073,13.64c0,1.992-1.615,3.607-3.607,3.607H1.093c-.316,0-.522-.304-.425-.595L5.915,2.429C6.425.984,7.785.012,9.316.012h2.757-.012Z" fill="url(#uuid-5a4cf215-4932-4f12-8af1-1b6833df259c)" fillRule="evenodd" strokeWidth="0"/>
    </svg>
);
